...
identifiers = [
    'const cpThemes =', 'let cpCurrentTheme', 'let cpGrid =', 'let cpWordPositions =',
    'let cpFoundWords =', 'let cpSelectedCells =', 'let cpTimer =', 'let cpSeconds =',
    'let cpIsRunning', 'let cpShowAnswers', 'let cpIsComplete', 'let cpPlacedCount',
    'let cpClearTimer', 'function cpLoadTheme', 'function cpGenerate',
    'function cpRenderGrid', 'function cpCellClick', 'function cpCheckWord',
    'function cpComplete', 'function cpToggleShow'
]
...
for var_name in ['let cpCurrentTheme', 'let cpGrid', 'let cpWordPositions', 'let cpFoundWords',
                  'let cpSelectedCells', 'let cpTimer', 'let cpSeconds', 'let cpIsRunning',
                  'let cpShowAnswers', 'let cpIsComplete', 'let cpPlacedCount', 'let cpClearTimer']:
