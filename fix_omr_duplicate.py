...
if count > 1:
    ...
    while True:
        ...
        if found > 1:
            ...
            content = content[:idx] + 'omrImageBase64 = omrImageBase64 || null' + content[idx + len('let omrImageBase64 = null'):]
        idx += 1
...
cp_funcs = ['function cpSetMode', 'function cpPopulateDiscSelect', 
            'function cpPopulatePeriodSelect', 'function cpLoadDiscVocab',
            'function cpGenerateFromDisc', 'var cpGenerateOriginal',
            'var cpLoadThemeOriginal', 'cpDiscVocabBase']
...
with open('/tmp/v3_jogos.js', 'w') as f:
    f.write(block)
result = subprocess.run(['node', '--check', '/tmp/v3_jogos.js'], 
