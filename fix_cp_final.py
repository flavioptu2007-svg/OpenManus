...
from fix_path_utils import read_file, resolve_v3_path


V3_PATH = resolve_v3_path()

content = read_file(V3_PATH)
...
for i, (s, e, l) in enumerate(positions):
    ...
    print(
        f"  Block {i+1}: {l} chars | cpThemes={cp_count}x | omr={has_omr} | orig={is_orig} | pos={s}-{e}"
    )
